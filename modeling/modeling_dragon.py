...
class RoBERTaGAT(BertEncoder):
    ...
    def __init__(self, config, args, k=5, n_ntype=4, n_etype=38, hidden_size=200, dropout=0.2, concept_dim=200,
        ...
        if k >= 1:
            ...
            self.hidden_layer_norm = nn.LayerNorm(hidden_size)
        ...
        for i, layer_module in enumerate(self.layer):
            ...
            if i >= self.num_hidden_layers - self.k:
                ...
                if self.info_exchange == True or (
                    ...
                    X, hidden_states = self.sk_message_passing(
                        X, gnn_mask, hidden_states, lm_mask)
    ...
    def sk_message_passing(self, X, gnn_mask, hidden_states, lm_mask):
        ...
        X = self.hidden_layer_norm(X_node + X)
        ...
        hidden_states = self.sent_layer_norm(hidden_states_node + hidden_states)
